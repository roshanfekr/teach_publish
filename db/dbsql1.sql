...
-- Dumping data for table tutorloo_teach.communications: ~2 rows (approximately)
/*!40000 ALTER TABLE `communications` DISABLE KEYS */;
REPLACE INTO `communications` (`id`, `name`, `accountId`, `userId`, `createdAt`, `updatedAt`) VALUES
...
-- Dumping data for table tutorloo_teach.files: ~1 rows (approximately)
/*!40000 ALTER TABLE `files` DISABLE KEYS */;
REPLACE INTO `files` (`id`, `path`, `ext`, `userId`, `createdAt`, `updatedAt`) VALUES
...
-- Dumping data for table tutorloo_teach.lessons: ~24 rows (approximately)
/*!40000 ALTER TABLE `lessons` DISABLE KEYS */;
REPLACE INTO `lessons` (`id`, `subject`, `code`, `isEnable`) VALUES
	(1, 'AERO 2001', 'AERO', 1),
	(2, 'AERO 3240', 'AERO', 1),
	(3, 'AERO 3700', 'AERO', 1),
	(4, 'AERO 4003', 'AERO', 1),
...
-- Dumping data for table tutorloo_teach.tutortimings: ~5 rows (approximately)
/*!40000 ALTER TABLE `tutortimings` DISABLE KEYS */;
REPLACE INTO `tutortimings` (`id`, `timeStart`, `timeEnd`, `dayOfWeek`, `userId`) VALUES
	(1, 2, 4, 2, 1),
	(2, 7, 9, 4, 1),
	(3, 14, 16, 2, 1),
	(4, 34, 36, 3, 1),
...
-- Dumping data for table tutorloo_teach.userlessons: ~2 rows (approximately)
/*!40000 ALTER TABLE `userlessons` DISABLE KEYS */;
REPLACE INTO `userlessons` (`id`, `lessonId`, `userId`, `description`, `acceptStatus`, `createdAt`, `updatedAt`) VALUES
...
-- Dumping data for table tutorloo_teach.userroles: ~2 rows (approximately)
...
-- Dumping data for table tutorloo_teach.users: ~2 rows (approximately)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
REPLACE INTO `users` (`id`, `email`, `password`, `emailConfirmCode`, `emailConfirmed`, `resetPasswordCode`, `name`, `lastName`, `acceptStatus`, `headline`, `bioMore`, `fileId`, `createdAt`, `updatedAt`) VALUES
