...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/user-panel/lessons.vue?vue&type=template&id=89ccc0fc&scoped=true&
var render = function render() {
  ...
  return _c('div', {
    ...
    attrs: {
      "id": "input-subject",
      "state": !_vm.$v.formData.lessonId.$error,
      "aria-describedby": "input-v-subject-feedback",
      "options": _vm.subjet_options,
      "trim": ""
    },
    model: {
      value: _vm.$v.formData.lessonId.$model,
      callback: function ($$v) {
        _vm.$set(_vm.$v.formData.lessonId, "$model", typeof $$v === 'string' ? $$v.trim() : $$v);
      },
      expression: "$v.formData.lessonId.$model"
    }
  }), _vm._v(" "), _c('b-form-invalid-feedback', {
    attrs: {
      "id": "input-v-subject-feedback"
    }
    ...
    attrs: {
      ...
      "state": !_vm.$v.formData.description.$error,
    ...
    on: {
      "input": function ($event) {
        ...
        _vm.$set(_vm.$v.formData.description, "$model", $event.target.value.trim());
      },
      "blur": function ($event) {
    ...
    attrs: {
      "id": "input-v-description-feedback"
    }
  }, [_vm._v("\n                " + _vm._s(this.$t("v_enter_Required")) + "\n              ")])], 1), _vm._v(" "), _c('b-row', {
    staticClass: "mt-2"
  }, [_c('b-col', {
  ...
  }, [_vm._v("Cancel")])], 1)], 1)], 1)]), _vm._ssrNode(" "), _vm._ssrNode("<div data-v-89ccc0fc>", "</div>", [_c('b-card', {
    ...
    attrs: {
      ...
      "show-empty": "",
      "hover": "",
      "items": _vm.t_subject_items,
      "fields": _vm.t_table_fields
    },
    scopedSlots: _vm._u([{
      ...
      fn: function (data) {
        return [_c('p', {
          ...
          attrs: {
            "id": 'tooltip-description' + data.item.id,
            "xmlns": "http://www.w3.org/2000/svg",
            "width": "16",
            "height": "16",
            "fill": "currentColor",
          ...
          attrs: {
            "target": 'tooltip-description' + data.item.id
          }
      ...
      fn: function (data) {
        return [_c('button', {
          ...
          on: {
            "click": function ($event) {
              return _vm.showDeleteComfirm(data);
            }
          }
      ...
      fn: function (data) {
        return [data.item.acceptStatus === 0 || data.item.acceptStatus === null || data.item.acceptStatus === undefined ? _c('b-badge', {
          attrs: {
            "variant": "warning"
          }
        }, [_vm._v(_vm._s(_vm.$t("pending")))]) : _vm._e(), _vm._v(" "), data.item.acceptStatus === 1 ? _c('b-badge', {
          attrs: {
            "variant": "success"
          }
