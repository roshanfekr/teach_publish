...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin/university.vue?vue&type=template&id=ddef45c4&scoped=true&
var render = function render() {
  ...
  return _c('b-container', [_c('b-row', {
  ...
  }, [_vm._v(_vm._s(_vm.header_title))]), _vm._v(" "), _c('b-button', {
  ...
  }, [_vm._v("Add New")])], 1)], 1), _vm._v(" "), _c('b-modal', {
    ref: "edit-modal",
    attrs: {
      "centered": "",
      "size": "lg",
    ...
    attrs: {
      ...
      "label": _vm.$t('university_name'),
      "label-for": "input-university_name"
    }
  }, [_c('b-form-input', {
    attrs: {
      "id": "input-university_name",
      "placeholder": _vm.$t('Please_enter_university_name'),
      "state": !_vm.$v.nData.name.$error,
      "aria-describedby": "input-university_name-feedback",
      "trim": ""
    },
    model: {
      value: _vm.$v.nData.name.$model,
      callback: function ($$v) {
        _vm.$set(_vm.$v.nData.name, "$model", typeof $$v === 'string' ? $$v.trim() : $$v);
      },
      expression: "$v.nData.name.$model"
    }
  }), _vm._v(" "), _c('b-form-invalid-feedback', {
    attrs: {
      "id": "input-university_name-feedback"
    }
    ...
    attrs: {
      ...
      "label-cols-lg": "4",
      "label-align-sm": "right",
      "label": _vm.$t('university_email'),
      "label-for": "input-email"
    }
  }, [_c('b-form-input', {
    attrs: {
      "id": "input-email",
      "placeholder": _vm.$t('university_email'),
      "state": !_vm.$v.nData.email.$error,
      "aria-describedby": "input-email-feedback",
      "trim": ""
    },
    model: {
      value: _vm.$v.nData.email.$model,
      callback: function ($$v) {
        _vm.$set(_vm.$v.nData.email, "$model", typeof $$v === 'string' ? $$v.trim() : $$v);
      },
      expression: "$v.nData.email.$model"
    }
  }), _vm._v(" "), _c('b-form-invalid-feedback', {
    attrs: {
    ...
    attrs: {
      ...
      "label-cols-lg": "4",
      "label-align-sm": "right",
      "label": _vm.$t('university_emailPattern'),
      "label-for": "input-university_emailPattern"
    }
  }, [_c('b-form-input', {
    attrs: {
      "id": "input-university_emailPattern",
      "placeholder": _vm.$t('university_emailPattern'),
      "state": !_vm.$v.nData.emailPattern.$error,
      "aria-describedby": "input-emailPattern-feedback",
      "trim": ""
    },
    model: {
      value: _vm.$v.nData.emailPattern.$model,
      callback: function ($$v) {
        _vm.$set(_vm.$v.nData.emailPattern, "$model", typeof $$v === 'string' ? $$v.trim() : $$v);
      },
      expression: "$v.nData.emailPattern.$model"
    }
  }), _vm._v(" "), _c('b-form-invalid-feedback', {
    attrs: {
      "id": "input-emailPattern-feedback"
    }
    ...
    attrs: {
      ...
      "label-cols-lg": "4",
      "label-align-sm": "right",
      "label": _vm.$t('admin.university.subdomain'),
      "label-for": "input-email"
    }
  }, [_c('b-form-input', {
    attrs: {
      "id": "input-subdomain",
      "placeholder": _vm.$t('admin.university.subdomain.placeholder'),
      "state": !_vm.$v.nData.host.$error,
      "aria-describedby": "input-subdomain-feedback",
      "trim": ""
    },
    model: {
      value: _vm.$v.nData.host.$model,
      callback: function ($$v) {
        _vm.$set(_vm.$v.nData.host, "$model", typeof $$v === 'string' ? $$v.trim() : $$v);
      },
      expression: "$v.nData.host.$model"
    }
  }), _vm._v(" "), _c('b-form-invalid-feedback', {
    attrs: {
      "id": "input-subdomain-feedback"
    }
    ...
    attrs: {
      ...
      "label-cols-lg": "4",
      "label-align-sm": "right",
      "label": _vm.$t('isactive'),
      "label-for": "input-isenable"
    }
  }, [_c('b-form-checkbox', {
    staticClass: "mt-2",
    attrs: {
      "id": "input-isenable",
      "placeholder": _vm.$t('isenable'),
      "trim": ""
    },
    model: {
      value: _vm.nData.isenable,
      callback: function ($$v) {
        _vm.$set(_vm.nData, "isenable", $$v);
      },
      expression: "nData.isenable"
    }
  })], 1)], 1)], 1), _vm._v(" "), _c('b-row', {
    staticClass: "mt-3"
    ...
    attrs: {
      "disabled": _vm.savingProgress,
      "variant": "primary"
    },
    on: {
      "click": this.save
    }
  }, [_vm._v(_vm._s(_vm.$t("save")) + "\n                  "), _vm.savingProgress ? _c('b-spinner', {
    attrs: {
      "small": ""
    }
  }) : _vm._e()], 1)], 1), _vm._v(" "), _c('b-col', [_c('b-button', {
  ...
  }, [_vm._v(_vm._s(_vm.$t("cancel")))])], 1)], 1)], 1)], 1)], 1), _vm._v(" "), _c('b-row', {}, [_c('b-overlay', {
    attrs: {
    ...
    scopedSlots: _vm._u([{
        ...
        return [_c('b-button', {
          ...
          on: {
            "click": function ($event) {
              return _vm.showEditModal(row.item);
            }
          }
        }, [_vm._v("Edit")])];
      }
      ...
      fn: function (row) {
        return [_c('b-button', {
          ...
          on: {
            "click": function ($event) {
              return _vm.deleteUniversity(row.item);
            }
          }
        }, [_vm._v("Delete")])];
      }
