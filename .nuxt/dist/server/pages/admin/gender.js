...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin/gender.vue?vue&type=template&id=22c8c5fa&scoped=true&
var render = function render() {
  ...
  return _c('b-container', [_c('b-row', {
  ...
  }, [_vm._v(_vm._s(_vm.$t("admin.gender.header")))]), _vm._v(" "), _c('b-button', {
    ...
    attrs: {
      ...
      "label": _vm.$t('admin.gender.field.title'),
      "label-for": "input-gender-title"
    }
  }, [_c('b-form-input', {
    attrs: {
      "id": "input-gender-title",
      "placeholder": _vm.$t('admin.gender.field.placeholder'),
      "state": !_vm.$v.nData.title.$error,
      "aria-describedby": "input-gender-title-feedback",
      "trim": ""
    },
    model: {
      value: _vm.$v.nData.title.$model,
      callback: function ($$v) {
        _vm.$set(_vm.$v.nData.title, "$model", typeof $$v === 'string' ? $$v.trim() : $$v);
      },
      expression: "$v.nData.title.$model"
    }
  }), _vm._v(" "), _c('b-form-invalid-feedback', {
    attrs: {
      "id": "input-gender-title-feedback"
    }
    ...
    model: {
      value: _vm.nData.disable,
      callback: function ($$v) {
        _vm.$set(_vm.nData, "disable", $$v);
      },
      expression: "nData.disable"
    }
  }, [_vm._v("\n                    Disable\n                  ")])], 1)], 1)], 1), _vm._v(" "), _c('b-row', {
    staticClass: "mt-3"
  ...
  }, [_vm._v(_vm._s(_vm.$t("save")))])], 1), _vm._v(" "), _c('b-col', [_c('b-button', {
