...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin/lessons.vue?vue&type=template&id=cb53752c&scoped=true&
var render = function render() {
  ...
  return _c('b-container', [_c('b-row', {
    ...
    on: {
      "click": this.addNewToggle
    }
  }, [_vm._v("Add New")]), _vm._v(" "), _c('b-button', {
    staticClass: "mb-2 ml-2",
    attrs: {
      "variant": "success"
    },
    on: {
      "click": this.addFromCVS
    }
  }, [_vm._v("Add From CVS")])], 1), _vm._v(" "), _c('div', {
    staticClass: "mt-4"
  }, [_c('b-row', {
    staticClass: "mt-2"
    ...
    model: {
      ...
      callback: function ($$v) {
        _vm.$set(_vm.searchData, "subject", $$v);
      },
    ...
    attrs: {
      ...
      "label-align-sm": "right",
      "label-size": "sm",
      "label": _vm.$t('admin.lessons.universities'),
      "label-for": "input-select-universities"
    }
  }, [_c('b-form-select', {
    attrs: {
      "id": "input-select-universities",
      "options": _vm.universities_options
    },
    model: {
      value: _vm.searchData.uniId,
      callback: function ($$v) {
        _vm.$set(_vm.searchData, "uniId", $$v);
      },
      expression: "searchData.uniId"
    }
  })], 1)], 1), _vm._v(" "), _c('b-col', {
    staticClass: "w-50"
  })], 1), _vm._v(" "), _c('b-row', {
    ...
    scopedSlots: _vm._u([{
      key: "cell(state)",
      fn: function (row) {
        return [row.item.stateValue ? _c('b-badge', {
          attrs: {
            "variant": "info"
          }
        }, [_vm._v("Enable")]) : _vm._e(), _vm._v(" "), !row.item.stateValue ? _c('b-badge', {
          attrs: {
            "variant": "warning"
          }
        ...
        return [_c('b-button', {
          ...
          on: {
            "click": function ($event) {
              return _vm.prepare_edit(row.item);
            }
          }
        }, [_vm._v("Edit")])];
      }
      ...
      fn: function (row) {
        return [_c('b-button', {
          ...
          on: {
            "click": function ($event) {
              return _vm.deleteLesson(row.item);
            }
          }
        }, [_vm._v("Delete")])];
      }
    ...
    attrs: {
      ...
      "label-align-sm": "right",
      "label": _vm.$t('subject'),
      "label-for": "input-subject_name"
    }
  }, [_c('b-form-input', {
    attrs: {
      "id": "input-subject",
      "placeholder": _vm.$t('please_enter_subject'),
      "state": !_vm.$v.nData.subject.$error,
      "aria-describedby": "input-lesson_subject-feedback",
      "trim": ""
    },
    model: {
      value: _vm.$v.nData.subject.$model,
      callback: function ($$v) {
        _vm.$set(_vm.$v.nData.subject, "$model", typeof $$v === 'string' ? $$v.trim() : $$v);
      },
      expression: "$v.nData.subject.$model"
    }
  }), _vm._v(" "), _c('b-form-invalid-feedback', {
    attrs: {
      "id": "input-lesson_subject-feedback"
    }
    ...
    attrs: {
      ...
      "label-align-sm": "right",
      "label": _vm.$t('admin.lessons.universities'),
      "label-for": "input-subject-universities"
    }
  }, [_c('b-form-select', {
    attrs: {
      "id": "input-select-universities",
    ...
    model: {
      value: _vm.nData.uniId,
      callback: function ($$v) {
        _vm.$set(_vm.nData, "uniId", $$v);
      },
      expression: "nData.uniId"
    }
  }), _vm._v(" "), _c('b-form-invalid-feedback', {
    attrs: {
      "id": "input-lesson-universities-feedback"
    }
  }, [_vm._v("\n              " + _vm._s(this.$t("v_enter_Required")) + "\n            ")])], 1)], 1)], 1), _vm._v(" "), _c('b-row', {
    staticClass: "mt-2"
  }, [_c('b-col', [_c('b-form-group', {
    ...
    model: {
      value: _vm.nData.active,
      callback: function ($$v) {
        _vm.$set(_vm.nData, "active", $$v);
      },
      expression: "nData.active"
    }
  })], 1)], 1)], 1), _vm._v(" "), _c('b-row', {
    staticClass: "mt-2"
  }, [_c('b-col', {
    ...
    staticClass: "m-center w-50 float-right",
    attrs: {
      "variant": "primary"
    },
    on: {
  ...
  }, [_vm._v("Save")])], 1), _vm._v(" "), _c('b-col', {
    staticClass: "float-left"
  }, [_c('b-button', {
    staticClass: "m-center w-50 float-left",
    attrs: {
      "variant": "primary"
    },
    on: {
  ...
  }, [_vm._v("Cancel")])], 1)], 1)], 1), _vm._v(" "), _c('b-modal', {
    ref: "add-modal-cvs",
    attrs: {
      "size": "lg",
      "centered": "",
    ...
    model: {
      value: _vm.cvsData.uniId,
      callback: function ($$v) {
        _vm.$set(_vm.cvsData, "uniId", $$v);
      },
      expression: "cvsData.uniId"
    }
  }), _vm._v(" "), _c('b-form-invalid-feedback', {
    attrs: {
      "id": "input-lesson-universities-feedback"
    ...
    model: {
      value: _vm.cvsData.active,
      callback: function ($$v) {
        _vm.$set(_vm.cvsData, "active", $$v);
      },
      expression: "cvsData.active"
    }
  })], 1)], 1)], 1), _vm._v(" "), _c('b-row', {
    staticClass: "mt-2"
  }, [_c('b-col', [_c('b-form-group', {
    ...
    attrs: {
      ...
      "label-cols-lg": "2",
      "label-align-sm": "right",
      "label": _vm.$t('admin.lessons.csv.upload.label'),
      "label-for": "input4"
    }
  }, [_c('b-form-file', {
    class: {
      'is-invalid': _vm.$v.cvsData.selectedFile.$error
    },
    staticStyle: {
      "direction": "ltr"
    },
    ...
    model: {
      value: _vm.$v.cvsData.selectedFile.$model,
      callback: function ($$v) {
        _vm.$set(_vm.$v.cvsData.selectedFile, "$model", $$v);
      },
      expression: "$v.cvsData.selectedFile.$model"
    }
  }), _vm._v(" "), _vm.cvsData.selectedFile ? _c('div', {
    staticClass: "mt-3"
    ...
    staticClass: "mx-2"
  }, [_vm._v(_vm._s(_vm.cvsData.selectedFile ? Math.trunc(_vm.cvsData.selectedFile.size / 1024) + " KB" : ''))])], 1) : _vm._e()], 1)], 1)], 1), _vm._v(" "), _c('b-row', {
    staticClass: "mt-2"
  }, [_c('b-col', {
    staticClass: "float-right"
  }, [_c('b-button', {
    staticClass: "m-center w-50 float-right",
    attrs: {
      "disabled": _vm.cvsSavingProgress,
      "variant": "primary"
    },
    on: {
      "click": this.saveCVSEdit
    }
  }, [_vm.cvsSavingProgress ? _c('b-spinner', {
    attrs: {
      "small": ""
    }
  }) : _vm._e(), _vm._v("\n          Save")], 1)], 1), _vm._v(" "), _c('b-col', {
    staticClass: "float-left"
  }, [_c('b-button', {
    staticClass: "m-center w-50 float-left",
    attrs: {
