...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin/reviews.vue?vue&type=template&id=9bae9300&scoped=true&
  ...
  methods: {
    ...
    search(index) {
      ...
      this.$axios.post('/review/getReviewSearch', this.searchData).then(res => {
        this.t_items = res.data.rows; // for (let i = 0; i < res.data.rows; i++) {
