...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/contact-us.vue?vue&type=template&id=b7280734&scoped=true&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "main-body-container-content mb-5"
  }, [_c('b-container', {
    staticClass: "container-padding"
  }, [_c('b-row', [_c('b-col', {
    staticClass: "text-center col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12"
  }, [_c('b-img', {
    attrs: {
      "alt": "teach",
      "width": "200",
  ...
  }, [_vm._v("info@tuteloop.ca")])])], 1), _vm._v(" "), _c('b-col', {
    staticClass: "col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12"
  }, [_c('div', {
    staticClass: "image-panel"
  }, [_c('b-img', {
    attrs: {
      "alt": "teach",
    ...
    staticClass: "col-xl-6 col-lg-6 col-md-7 col-sm-12 col-12"
  }, [_vm.show ? _c('b-form', {
    staticClass: "w-100",
    on: {
  ...
  }, [_vm._v("Send your message")]), _vm._v(" "), _c('b-form-group', {
    attrs: {
      "id": "input-group-1",
      "label": "Name ",
      "label-for": "input-1"
  ...
  }), _vm._v(" "), !_vm.$v.form.name.required ? _c('div', {
    staticClass: "invalid-feedback"
  }, [_vm._v("Name is required\n                ")]) : _vm._e(), _vm._v(" "), !_vm.$v.form.name.serverError ? _c('div', {
    staticClass: "invalid-feedback"
  }, [_vm._v(_vm._s(_vm.errors.name.msg))]) : _vm._e()], 1), _vm._v(" "), _c('b-form-group', {
    attrs: {
      "id": "input-group-2",
      "label": "Subject ",
      "label-for": "input-2"
    ...
    class: {
      'is-invalid': _vm.$v.form.subject.$error,
      'is-valid': !_vm.$v.form.subject.$invalid
    },
    attrs: {
      "autocomplete": "off",
      "id": "input-2"
    ...
    model: {
      ...
      callback: function ($$v) {
        _vm.$set(_vm.$v.form.subject, "$model", typeof $$v === 'string' ? $$v.trim() : $$v);
      },
      expression: "$v.form.subject.$model"
    }
  }), _vm._v(" "), !_vm.$v.form.subject.required ? _c('div', {
    staticClass: "invalid-feedback"
  }, [_vm._v("Required\n                ")]) : _vm._e(), _vm._v(" "), !_vm.$v.form.subject.serverError ? _c('div', {
    staticClass: "invalid-feedback"
  }, [_vm._v(_vm._s(_vm.errors.subject.msg))]) : _vm._e()], 1), _vm._v(" "), _c('b-form-group', {
    attrs: {
      "id": "input-group-3",
      "label": "Email ",
      "label-for": "input-3"
    ...
    staticClass: "invalid-feedback"
  }, [_vm._v("Email format not correct\n                ")]) : _vm._e(), _vm._v(" "), !_vm.$v.form.email.serverError ? _c('div', {
    staticClass: "invalid-feedback"
  }, [_vm._v(_vm._s(_vm.errors.email.msg))]) : _vm._e()], 1), _vm._v(" "), _c('b-form-group', {
    attrs: {
      "id": "input-group-4",
      "label": "Message ",
      "label-for": "input-4"
    ...
    class: {
      'is-invalid': _vm.$v.form.msg.$error,
      'is-valid': !_vm.$v.form.msg.$invalid
    },
    attrs: {
      "id": "input-4",
      "autocomplete": "off",
    ...
    model: {
      value: _vm.$v.form.msg.$model,
      callback: function ($$v) {
        _vm.$set(_vm.$v.form.msg, "$model", typeof $$v === 'string' ? $$v.trim() : $$v);
      },
      expression: "$v.form.msg.$model"
    }
  }), _vm._v(" "), !_vm.$v.form.msg.required ? _c('div', {
    staticClass: "invalid-feedback"
  }, [_vm._v("Message is required\n                ")]) : _vm._e(), _vm._v(" "), !_vm.$v.form.msg.serverError ? _c('div', {
    staticClass: "invalid-feedback"
  }, [_vm._v(_vm._s(_vm.errors.msg.msg))]) : _vm._e()], 1), _vm._v(" "), _c('b-button', {
    staticClass: "m-2",
    attrs: {
      "type": "submit",
      "variant": "primary"
  ...
  }, [_vm._v("Send message success.")]), _vm._v(" "), _c('b-button', {
    staticClass: "m-2",
    attrs: {
      "variant": "primary"
    },
