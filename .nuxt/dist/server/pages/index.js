...
return [_vm._v("\n                  This is the no options slot.\n                ")]}}],null,false,3133451459),model:{value:(_vm.selectedUniversity),callback:function ($$v) {_vm.selectedUniversity=$$v},expression:"selectedUniversity"}}):_vm._e(),_vm._v(" "),_c('v-select',{staticClass:"m-v-select-2 m-v-select",attrs:{"placeholder":_vm.$t('page.first.subjets.placeholder'),"loading":_vm.lessonLoading,"filterBy":_vm.filterBy,"options":_vm.options,"label":"code"},scopedSlots:_vm._u([{key:"option",fn:function(ref){
var code = ref.code;
return [_vm._v("\n                  "+_vm._s(code)+"\n                ")]}},{key:"no-options",fn:function(ref){
var search = ref.search;
var searching = ref.searching;
