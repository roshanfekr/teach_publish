...
var add = __webpack_require__(8).default
module.exports.__inject__ = function (context) {
  add("7f59264d", content, true, context)
};
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".m-v-select{font-size:1.3rem;width:calc(100% - 100px)}.m-v-select .vs__search::-moz-placeholder{background:#fff!important;border-top-left-radius:4px;border-top-right-radius:0;border-bottom-right-radius:0;border-bottom-left-radius:4px}.m-v-select .vs__search:-ms-input-placeholder{background:#fff!important;border-top-left-radius:4px;border-top-right-radius:0;border-bottom-right-radius:0;border-bottom-left-radius:4px}.m-v-select .vs__dropdown-menu,.m-v-select .vs__dropdown-toggle,.m-v-select .vs__search::placeholder{background:#fff!important;border-top-left-radius:4px;border-top-right-radius:0;border-bottom-right-radius:0;border-bottom-left-radius:4px}.m-v-select .vs__clear{margin-top:-4px;margin-right:10px;fill:var(--color1)}.m-v-select .vs__open-indicator{margin-right:5px;fill:var(--color1)}.img-fluid{display:none!important}.carousel{min-height:500px!important}.carousel-caption{position:relative!important;top:0;right:0;left:0}.carousel-indicators li{background-color:var(--color1)!important}.m-slider{color:#888}", ""]);
// Exports
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_1_id_a1d0c4d8_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(118);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_1_id_a1d0c4d8_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_1_id_a1d0c4d8_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_1_id_a1d0c4d8_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_1_id_a1d0c4d8_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".btn-search[data-v-a1d0c4d8]{width:100px}.m-icon[data-v-a1d0c4d8]{font-size:xxx-large;color:var(--color1)}.main-bg[data-v-a1d0c4d8]{min-height:calc(100vh - 63px);background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");background-size:100% 100%;background-position:top;background-repeat:no-repeat}.search-container[data-v-a1d0c4d8]{padding-top:7%}.m-panel[data-v-a1d0c4d8]{z-index:999;margin-top:-100px;background:transparent!important}.round-panel[data-v-a1d0c4d8]{background:#fff;border-radius:20px}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
fontawesome_svg_core_["library"].add(free_brands_svg_icons_["faSearchengin"]);
/* harmony default export */ var lib_vue_loader_options_pagesvue_type_script_lang_js_ = ({
  ...
  methods: {
    Init() {
      ...
      if (!this.subdomain) this.loadUniversity();else this.loadSubjects(this.host);
    },
    ...
    loadSubjects(subname) {
      ...
      let data = {};
      if (this.uniId != null && this.uniId > 0) data["uniId"] = this.uniId;
      if (this.subdomain) data["host"] = this.host;
    ...
    clickSearch() {
      if (this.selected) this.$router.push("/tutors/1?subject=" + this.selected.id);
    }
